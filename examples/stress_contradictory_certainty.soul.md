...
- **hedging** — 90/100 (very high). Qualifies everything (noise risk at max).
...
- **confidence** — 90/100 (very high). Flat assertion: 'this is the case.'
...
- **contradictory_certainty** — High hedging with high confidence produces contradictory output.
