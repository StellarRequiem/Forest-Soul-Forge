...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 01:33Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 01:33Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,704** |
| ADRs filed | **90** files / **88** unique numbers |
| Builtin tools | **100** |
| Tests | **5,223** `def test_` across **263** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`a2b2649`** · **692** commits on `main` _(VCS provenance — advances every commit)_ |
