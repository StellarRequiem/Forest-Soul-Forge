...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 22:34Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 22:34Z) |
|---:|:---|
...
| As of | **`c03d44f`** · **683** commits on `main` _(VCS provenance — advances every commit)_ |
