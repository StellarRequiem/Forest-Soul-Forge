...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 20:53Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 20:53Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **103,292** |
...
| As of | **`e62412d`** · **716** commits on `main` _(VCS provenance — advances every commit)_ |
| Registry agents | **67 active / 5 archived / 72 total** _(local runtime DB — gitignored, absent in CI)_ |
| Audit chain entries | **7** at `examples/audit_chain.jsonl` _(grows continuously at runtime — snapshot only)_ |
