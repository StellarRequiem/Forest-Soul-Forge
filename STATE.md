...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 21:31Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 21:31Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,645** |
| ADRs filed | **89** files / **87** unique numbers |
| Builtin tools | **100** |
| Tests | **5,217** `def test_` across **262** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`424865d`** · **680** commits on `main` _(VCS provenance — advances every commit)_ |
