...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 02:43Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 02:43Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **102,121** |
| ADRs filed | **91** files / **89** unique numbers |
| Builtin tools | **100** |
| Tests | **5,242** `def test_` across **266** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`50c6eeb`** · **696** commits on `main` _(VCS provenance — advances every commit)_ |
