...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 03:49Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 03:49Z) |
|---:|:---|
...
| As of | **`75ec532`** · **698** commits on `main` _(VCS provenance — advances every commit)_ |
| Registry agents | **67 active / 5 archived / 72 total** _(local runtime DB — gitignored, absent in CI)_ |
| Audit chain entries | **27,841** at `examples/audit_chain.jsonl` _(grows continuously at runtime — snapshot only)_ |
