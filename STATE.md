...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 00:44Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 00:44Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,689** |
...
| As of | **`1927e42`** · **689** commits on `main` _(VCS provenance — advances every commit)_ |
