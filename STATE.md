...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 23:31Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 23:31Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,655** |
| ADRs filed | **89** files / **87** unique numbers |
| Builtin tools | **100** |
| Tests | **5,220** `def test_` across **263** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`e8b6288`** · **687** commits on `main` _(VCS provenance — advances every commit)_ |
| Registry agents | **67 active / 5 archived / 72 total** _(local runtime DB — gitignored, absent in CI)_ |
| Audit chain entries | **27,818** at `examples/audit_chain.jsonl` _(grows continuously at runtime — snapshot only)_ |
