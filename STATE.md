...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 02:13Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 02:13Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,992** |
| ADRs filed | **91** files / **89** unique numbers |
| Builtin tools | **100** |
| Tests | **5,234** `def test_` across **265** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`dc47c4e`** · **694** commits on `main` _(VCS provenance — advances every commit)_ |
