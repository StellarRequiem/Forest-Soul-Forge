...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 21:10Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 21:10Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,645** |
| ADRs filed | **88** files / **86** unique numbers |
| Builtin tools | **100** |
...
| As of | **`31f74e2`** · **678** commits on `main` _(VCS provenance — advances every commit)_ |
