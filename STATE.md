...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 22:54Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 22:54Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,655** |
| ADRs filed | **89** files / **87** unique numbers |
| Builtin tools | **100** |
| Tests | **5,218** `def test_` across **262** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`b609959`** · **686** commits on `main` _(VCS provenance — advances every commit)_ |
