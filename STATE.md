...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 01:29Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 01:29Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,690** |
...
| As of | **`ffb5b04`** · **691** commits on `main` _(VCS provenance — advances every commit)_ |
