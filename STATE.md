...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-03 21:27Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-03 21:27Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **101,645** |
| ADRs filed | **89** files / **87** unique numbers |
| Builtin tools | **100** |
| Tests | **5,215** `def test_` across **262** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`f8337c9`** · **679** commits on `main` _(VCS provenance — advances every commit)_ |
