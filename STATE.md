...
<!-- CANON:BEGIN — generated by dev-tools/state_canon.py --emit on 2026-06-04 04:27Z. Do not hand-edit; run `--check` to verify against disk. -->

| Surface | Canon (generated 2026-06-04 04:27Z) |
|---:|:---|
| Python LoC (`src/forest_soul_forge/`) | **102,764** |
| ADRs filed | **92** files / **90** unique numbers |
| Builtin tools | **101** |
| Tests | **5,272** `def test_` across **270** files _(structural count — suite GREEN/pass-count is a CI artifact, not asserted here)_ |
...
| As of | **`3361662`** · **700** commits on `main` _(VCS provenance — advances every commit)_ |
