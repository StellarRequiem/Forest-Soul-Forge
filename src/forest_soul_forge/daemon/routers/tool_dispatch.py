...
async def call_tool(
    ...
    # ADR-0095 — trust recording happens inside the dispatcher's universal
    # outcome sink (_record_call_safe), NOT here: that captures every caller
    # (scheduler, delegation, conversations, skills), not just this HTTP path,
    # and avoids double-counting the fast-path call.
